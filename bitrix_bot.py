...
BUILTIN_RULES = {
    ...
    "ЕЛЕНА СОСЛАНОВНА": ("Заработная плата (ПВЗ)", "Бизнес"),
    "ТАМАРА ВАЛЕРЬЯНОВНА": ("Заработная плата (ПВЗ)", "Бизнес"),

    # Долг (Бизнес)
    "ТУРПАЛ-АЛИ САЙХАНОВИЧ": ("Долг", "Бизнес"),

    # Личные переводы
    "НАТАЛЬЯ ВЯЧЕСЛАВОВНА": ("Личные переводы", "Личное"),
    "EVGENII": ("Личные переводы", "Личное"),
    "БАРАКАТУЛЛОИ ХАЙРУЛЛО": ("Личные переводы", "Личное"),
